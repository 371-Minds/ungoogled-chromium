...
const TRUSTED_DOMAINS = ["localhost:8004", "identity.371.internal"];
...
setInterval(() => {
  ...
  if (TRUSTED_DOMAINS.includes(host) || host.endsWith(".internal")) return; // Skip security evaluation for trusted local services
